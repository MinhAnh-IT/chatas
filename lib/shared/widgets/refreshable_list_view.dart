  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        padding: padding ?? const EdgeInsets.all(RefreshableListViewConstants.defaultPadding),
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: RefreshableListViewConstants.defaultSpacing),
                Text(
                ...
                if (onRetry != null) ...[
                  ...
                  ElevatedButton(
                    onPressed: onRetry,
                    child: const Text(RefreshableListViewConstants.defaultRetryButtonText),
                  ),
                ],
              ],
            ),
