...
void main() {
  group('JoinGroupUseCase', () {
    ...
    setUp(() {
      ...
      useCase = JoinGroupUseCase(fakeRepository);
    });

    test('should call repository joinGroup with correct parameters', () async {
      // arrange
      ...
      // assert
      expect(fakeRepository.joinGroupCalled, isTrue);
    ...
    test('should throw exception when threadId is empty', () async {
      ...
      expect(fakeRepository.joinGroupCalled, isFalse);
    });
