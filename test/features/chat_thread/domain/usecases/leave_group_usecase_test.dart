...
void main() {
  group('LeaveGroupUseCase', () {
    ...
    setUp(() {
      ...
      useCase = LeaveGroupUseCase(fakeRepository);
    });

    test('should call repository leaveGroup with correct parameters', () async {
      // arrange
    ...
    test('should throw exception when threadId is empty', () async {
      ...
      expect(fakeRepository.leaveGroupCalled, isFalse);
    });
